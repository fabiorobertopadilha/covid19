...
output$selectMunicipios <- renderUI({
  ...
  fillCol(height = 200, flex = c(NA, 1), 
    ...
    uiOutput("perfilPaciente", height = "100%")
  )
})
```
...
observeEvent(input$btnCalcular, {
  ...
  calcularProbabilidade(modeloRegressaoLogistica, TRUE, 40, TRUE, "Brancssa")
