...
Neste capítulo, utiliza-se técnicas de machine learning para identificar outros atributos com impacto no risco de óbito dos pacientes, além dos atributos já descritos nas seções anteriores novos atributos serão incorporados aos modelos e os tipos de algoritmos também serão diversificados. 
...
Na primeira execução, o algoritmos utilizado será o rpart e os atributos serão os mesmos utilizados nas seção de inferência estatística. Com essa configuração a taxa de acerto do modelo foi de, aproximadamente, 64% (sessenta e quatro por cento). Abaixo segue trecho de código utilizado: 
