...
Por último, foi relalizada uma execução com os mesmo atributos da seção 6.3 e o método Naive Bayse do pacote e1071. Com esta configuração, o resultado da taxa de acerto foi um pouco menor, chegando a, aproximadamente, 68% (sessenta e oito por cento). Abaixo segue trecho de código utilizado: 
...
O dashboard amplia a possíbilidade de consulta, indo além das informações apresentadas neste trabalho. Ele permite também uma abordagem em drill down, sendo possível uma analise em nível de: Brasil, regiões, estados e municípios.
...
A Tabela \ref{tab:links} dispõe dos links com os código fontes implementados neste tabalho, do link do deploy da aplicação (dashboard implementado), bem como do link com o backup dos dados utlizados.
...
Disponível em: < \href{https://www.bbc.com/portuguese/geral-52481818}{\underline{\color{blue} https://www.bbc.com/portuguese/geral-52481818}} > - Acessado em: 14 jan. 2021
\bibitem[2]{GOMES:2019}
GOMES, Pedro César Tebaldi.
Classificação com Naive Bayes. \textbf{DATA GEEKS, 2019.}
Disponível em: < \href{https://www.datageeks.com.br/naive-bayes/}{\underline{\color{blue} https://www.datageeks.com.br/naive-bayes/}} > - Acessado em: 14 jan. 2021 
...
MEHTA, \textbf{R. Big Data Analytics with Java.} Birmingham: Packt Publishing Ltd, 2017.
\bibitem[6]{OPENDATASUS:2021}
Portal OpenDataSUS, SRAG 2021 - Banco de Dados de Síndrome Respiratória. \textbf{SUS, 2021.}
Disponível em: < \href{https://opendatasus.saude.gov.br/dataset/bd-srag-2021}{\underline{\color{blue} https://opendatasus.saude.gov.br/dataset/bd-srag-2021}} >  - Acessado em: 14 jan. 2021
